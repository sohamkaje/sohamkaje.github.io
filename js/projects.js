 ...
 * projects.js
 * -----------
 * Reads every file listed in PROJECT_FILES, fetches its JSON,
 * then renders a project card in #projects-grid and a modal in
 * #modals-container. To add a new project, just drop a new JSON
 * file in js/projects/ and add its filename to the list below.
 */
...
async function loadProjects() {
    ...
    results.forEach(p => {
        ...
        modals.insertAdjacentHTML('beforeend', buildModal(p));
    });
